...
<section id="boninstagram">
    <div class="instagram-carousel-container clearfix block {if $display_caroucel}hidden{/if}">
        <div class="instagram-home-title revealOnScroll animated fadeInUp" data-animation="fadeInUp">
            <h3>{l s='Sekite mus Instagram' mod='boninstagramslick'}</h3>
            <a href="https://www.instagram.com/aleksistore/">
                <span class="instagram-icon">aleksistore</span>
            </a>
        </div>
        <div class="block_content">
            <ul class="{if $display_caroucel}slick-carousel-instagram {else}clearfix{/if}">
                {for $i=1 to $limit}
                    <li class="instagram-item {if !$display_caroucel}instagram-item-gallery{/if} revealOnScroll animated fadeInUp" data-animation="fadeInUp" >
                        <a href="https://www.instagram.com/{if $instagram_type == "tagged"}{$user_tag|escape:'htmlall':'UTF-8'}{else}{$user_id|escape:'htmlall':'UTF-8'}{/if}/" target="_blank" rel="nofollow">
    ...
    <div class="instagram-button">
        <a href="https://instagram.com/aleksistore/" class="btn btn-primary"><span class="instagram-icon">Sekite mus Instagram</span></a>
    </div>
</section>