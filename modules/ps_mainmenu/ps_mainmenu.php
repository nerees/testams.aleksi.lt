...
class Ps_MainMenu extends Module implements WidgetInterface
{
    ...
    public function install($delete_params = true)
    {
        if (!parent::install() ||
            ...
            !$this->registerHook('displayNnMenu')) {
            return false;
        }
    ...
    {
        $nodes = [];
        $notRequiredChildren = [108, 109, 110, 112, 113, 114, 115, 116, 117]; //do not wand display as submenu theese cat
        ...
        foreach ($categories as $key => $category) {
            ...
            if (in_array((int)$category['id_category'], $notRequiredChildren)){
                continue;
            }
