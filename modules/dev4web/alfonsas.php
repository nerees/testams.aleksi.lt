...
$objXmlDocument = simplexml_load_string(file_get_contents("newalfonsas.xml"), 'SimpleXMLElement', LIBXML_NOCDATA);
...
$stax = [95, 96, 97, 98]; //47
$vasarosPrekes = [152]; //48
$playMais = [91]; //49
$creative = [41]; //50
$bino = [101]; //52
$pionierius = [139]; //51
$snails = [169,49,88,89,90,87,44,83]; //53
$splat = [92]; //54
$smagiai = [159, 160, 161, 172, 174, 175, 176, 177]; //55
$splat_plannet = [54];

$allBrands = array_merge($stax, $vasarosPrekes, $playMais, $creative, $bino, $pionierius, $snails, $splat, $smagiai);
