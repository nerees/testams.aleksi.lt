...
<div class="container home-categories-tabs">
    <section class="accordion">
        <section class="accordion-tabs">
            <button class="accordion-tab accordion-active" data-actab-group="0" data-actab-id="0">AKCIJOS</button>
            <button class="accordion-tab" data-actab-group="0" data-actab-id="1">VAIKAMS</button>
            <button class="accordion-tab" data-actab-group="0" data-actab-id="2">MOTERIMS</button>
            <button class="accordion-tab" data-actab-group="0" data-actab-id="3">VYRAMS</button>
            <button class="accordion-tab" data-actab-group="0" data-actab-id="4">NAMAMS</button>
        </section>
