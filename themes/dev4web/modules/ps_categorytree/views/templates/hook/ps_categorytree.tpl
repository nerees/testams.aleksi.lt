...
<div class="block-categories" style="min-width: 220px;">
  <ul class="category-top-menu">
    <li class="nn-cat-menu-head"><a class="text-uppercase h6" href="{$categories.link nofilter}">{$categories.name}</a></li>
