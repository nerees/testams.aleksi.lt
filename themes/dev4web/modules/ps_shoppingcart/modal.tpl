  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title h6 text-sm-center" id="myModalLabel"><i class="material-icons rtl-no-flip">&#xE876;</i>Prekė sėkmingai pridėta</h4>
      </div>
          ...
          <div class="col-md-7">
            <div class="cart-content">
              ...
              <div class="cart-content-btn">
                <button type="button" class="btn btn-secondary" data-dismiss="modal" style="min-width:281px;">{l s='Continue shopping' d='Shop.Theme.Actions'}</button>
